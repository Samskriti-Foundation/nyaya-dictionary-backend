...
from app.routers import db_managers, search, upload, auth, words, word_antonyms, word_derivations, word_etymologies, word_synonyms, word_translations, word_examples, word_reference_nyaya_texts
